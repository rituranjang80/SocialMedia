...
> **Maintained docs:** For an up-to-date, LLM-friendly overview see [docs/ARCHITECTURE.md](../docs/ARCHITECTURE.md).  
> For API + Swagger reference see [docs/API.md](../docs/API.md).  
> This file is the original detailed architecture spec.
