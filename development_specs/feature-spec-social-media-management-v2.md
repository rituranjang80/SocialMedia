...
> **Maintained docs:** [docs/FEATURES.md](../docs/FEATURES.md) (API vs UI coverage), [docs/API.md](../docs/API.md) (Swagger / Agent API), [docs/ARCHITECTURE.md](../docs/ARCHITECTURE.md).
